...
public class RoleController {
	...
	@GetMapping("/")
	private @ResponseBody List<Role> getAll(){
	...
	@GetMapping("/find-{id}")
	private @ResponseBody Optional<Role> findById(@PathVariable("id") int id) {
		return roleService.findById(id);
	}
	
	//update haveSpecialty
	@PutMapping("/update-{id}")
	private @ResponseBody Role update(@PathVariable("id") int id, @RequestBody Role role) {
